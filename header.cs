 ...
 * ------------------------------------------------------------
 * Project Name:      [Insert upstream project name]
 * Original Author:   [Insert author / organisation]
 * Source URL:        [Insert repository or reference link]
 * License:           [GPL / MIT / Other - specify exact version]
 *
 * ------------------------------------------------------------
 * MODIFICATIONS
 * ------------------------------------------------------------
 ...
 *
 * - Ported to C# from [original language]
